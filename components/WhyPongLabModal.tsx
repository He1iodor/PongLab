            ...
            >
              ...
              <section className="snap-start text-center py-20">
                ...
                <p className="mt-10 text-xl text-white/65 max-w-3xl mx-auto">
                  Пока обычная тренировка тратит время на ожидание и паузы,
                  PongLab позволяет концентрироваться исключительно на практике.
                </p>
              </section>
              ...
              <section className="snap-start grid lg:grid-cols-2 gap-12 px-10 py-20">
                ...
                <div>
                  ...
                  <p className="mt-10 text-xl text-white/65 max-w-xl leading-relaxed">
                    ...
                    с одинаковой точностью. Именно такая повторяемость помогает быстрее
                    закреплять технику.
                  </p>
                </div>
              </section>
              ...
              <section className="snap-start text-center py-20">
                ...
                <p className="mt-10 text-xl text-white/65 max-w-3xl mx-auto">
                  Чем больше качественных повторений, тем быстрее формируется стабильный игровой навык.
                </p>
              </section>
              ...
              <section className="snap-start px-10 py-20">
                ...
                <div className="grid lg:grid-cols-2 gap-10">
                  ...
                  <div className="rounded-[40px] border border-white/10 bg-white/[0.04] p-10">
                    <div className="text-white/50 text-sm uppercase tracking-[0.2em] mb-6">
                      Обычные тренировки
                    </div>

                    <h3 className="text-3xl font-bold mb-8">
                      Большая часть времени уходит не на игру
                    </h3>
                  ...
                  {/* RIGHT */}
                  <div className="rounded-[40px] border border-[#8F5BFF]/30 bg-[#8F5BFF]/10 p-10">
                    <div className="text-[#CDB8FF] text-sm uppercase tracking-[0.2em] mb-6">
                      PongLab
                    </div>

                    <h3 className="text-3xl font-bold mb-8">
                      Почти всё время занимает практика
                    </h3>
              ...
              <section className="snap-start grid lg:grid-cols-2 gap-12 px-10 py-20">
                <div>
                  ...
                  <p className="mt-10 text-xl text-white/65 max-w-xl">
                    Следите за количеством тренировок, ударами, прогрессом и личной статистикой.
                  </p>
                </div>

                <div className="rounded-[40px] border border-white/10 bg-white/[0.04] p-10">
                  <div className="mb-10">
                    <div className="text-white/60 mb-2">Активность</div>
              ...
              <section className="snap-start text-center py-20">
                ...
                <p className="mt-10 text-xl text-white/65 max-w-3xl mx-auto">
                  Больше повторений. Больше контроля. Больше прогресса.
                </p>
              </section>
