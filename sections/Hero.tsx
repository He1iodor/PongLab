...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* 🟣 BALL (LEVEL 3 + BIGGER + TENNIS LOOK) */}
      <motion.div
      ...
      >
        ...
        <div
          ...
          style={{
            width: 26 + ball.speed * 0.5,
            height: 26 + ball.speed * 0.5,
            background:
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 14px rgba(255,255,255,0.9), 0 0 24px rgba(143,91,255,0.5)",
          }}
        />
