        ...
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <button className="rounded-2xl px-8 py-4 font-semibold bg-[#6B30CE] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(107,48,206,.7)]">
                Попробовать
              </button>
            ...
            <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6">
                ...
                <div className="mt-2 text-white/60">тренировок</div>
              </div>
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6">
                ...
                <div className="mt-2 text-white/60">ударов за сессию</div>
              </div>

              <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6">
                <div className="text-3xl md:text-4xl font-black">24/7</div>
                <div className="mt-2 text-white/60">доступность</div>
              </div>
            </div>
          </motion.div>
